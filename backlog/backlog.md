...
Phase 1 (first login / first 2 days of emails)
1. Choose your assistants email address
2. Manually just forward most recent 10 school emails. (reccommend 10, but allow 5).
3. Add Child Profiles
4. Process everything and send 1st email.

Phase 2 
1. Welcome email + how to make assistant more useful/fully automate your Assistant.
2. Setup auto-forwarding

Phase 3
1. After 7 days, lose access or continue?